...
public class CommandPartyKick extends SFCommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, String label, String[] args) {
        ...
        player.sendMessage(Reference.PREFIX + offlinePlayer.getName() + "님을 팜에서 추방하였습니다.");
        if (offlinePlayer.isOnline()) {
            offlinePlayer.getPlayer().sendMessage(Reference.PREFIX + "팜에서 추방당하였습니다.");
        }
        return true;
    }
}